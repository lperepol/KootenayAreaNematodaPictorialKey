...
def draw():
    ...
    g.edge('004','005', label='Visible')
    g.edge('004','022', label='Absent')

    g.node('005', 'Females',fillcolor='aqua',style="filled" )
    g.edge('005','006', label='Eel-like')
    g.edge('005','021', label='Swollen')

    g.node('006', 'Vulva', fillcolor='aqua', style="filled")
    g.edge('006', '007', label='Mid-body')
    g.edge('006', '014', label='Lower third')

    g.node('007', 'Esophagus', fillcolor='aqua', style="filled")
    g.edge('007', '008', label='No\noverlap')
    g.edge('007', '011', label='Overlapping\nintestine')
    ...
    g.node('Genus\n', shape='doubleoctagon', color='blue', fillcolor='aquamarine3',style="rounded,filled")
    ...
    g.node('046', 'Tooth\mPosition',fillcolor='aqua',style="filled" )
    g.node('Genus\nIotonchus', shape='doubleoctagon', color='blue', fillcolor='aquamarine3',style="rounded,filled")
    g.edge('046', '', label='In botton part of stoma')
